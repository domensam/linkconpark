...
import { idlFactory } from './certificate_canister_frontend.did.js';
export { idlFactory } from './certificate_canister_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CERTIFICATE_CANISTER_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./certificate_canister_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the certificate_canister_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./certificate_canister_frontend.did.js")._SERVICE>}
 */
export const certificate_canister_frontend = createActor(canisterId);
