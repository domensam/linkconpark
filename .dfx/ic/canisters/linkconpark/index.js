...
import { idlFactory } from './linkconpark.did.js';
export { idlFactory } from './linkconpark.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LINKCONPARK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./linkconpark.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the linkconpark canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./linkconpark.did.js")._SERVICE>}
 */
export const linkconpark = createActor(canisterId);
